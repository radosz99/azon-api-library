...
class Entry:
    def __init__(self,pk,title,entry_type, entry_type_id, partner, scientific_domain, authors, co_creators, attachments_number,highlight='',file_result=''):
        self.pk=pk
        self.title=title
...
def get_article(json_data):
    ...
    if(item['numeration']==None): #inbook
        info['publisher']=item['publisher']
        info['address']=item['publish_place']
